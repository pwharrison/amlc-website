...
<div class="speaker-profile">
    ...
    <img src="/assets/images/2026/speakers/Nidhi_Gupta.jpg" alt="Nidhi Gupta">
  </div>
  <div class="speaker-profile-info">
    <h3>Nidhi Gupta</h3>
    <p><em>PagerDuty - Applied Scientist</em></p>
    <p>Nidhi Gupta is an Applied Scientist at PagerDuty, where she designs and implements production‑grade AI systems, including contributions to the company’s agentic  Shift Agent  platform. Her work focuses on AI reliability, evaluation frameworks, and multilingual enablement—most recently delivering Japanese language support for global customers. Passionate about operationalizing trustworthy AI, she builds frameworks that balance performance, observability, and governance to make enterprise AI systems reliable, explainable, and impactful.</p>
  </div>
</div>
